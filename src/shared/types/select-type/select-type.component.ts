...
//       multi: true,
//       useExisting: SelectTypeComponent
//     }
//   ]
// })
// export class SelectTypeComponent implements ControlValueAccessor, OnInit, OnDestroy {

//   @ViewChild(NgSelectComponent, {static: true}) selectComponent!: NgSelectComponent;
//   private itemsSubject$ = new BehaviorSubject<any[]>([]);
//   private items = [];
//   @Input() items$ = this.itemsSubject$.asObservable();
//   @Input() serverSide: boolean = true;
//   searchInput$ = new Subject<string>();

//   private value;

//   @Input() url = environment.apiUrl + '/data/autocomplete';
